...
import edu.ufp.inf.sd.rmi.observer.server.ObserverImpl;
...
public class ObserverServer {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] edu.ufp.sd.edu.ufp.inf.sd.rmi._01_helloworld.server.HelloWorldServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
            ObserverServer hws = new ObserverServer(args);
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                ...
                registry.rebind(serviceUrl, observerRI);
