package edu.ufp.inf.sd.rmi._03_pingpong_solved.client;
...
public class PongClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            System.err.println("usage: java [options] edu.ufp.sd.inf.rmi.edu.ufp.inf.sd.rmi._01_helloworld.server.HelloWorldClient <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
    ...
    private void playService() {
        try {
            ...
            double sum = this.calculatorRI.add(1,2);

            Logger.getLogger(this.getClass().getName()).log(Level.INFO, "sum="+sum);
